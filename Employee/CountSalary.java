...
public class CountSalary {
  public  static void June(Employee e1){
    System.out.println("Lương tháng 6: "+(4*5* e1.salary)+"vnd");
  }
  public  static void July(Employee e1){
    System.out.println("Lương tháng 7: "+(4*5* e1.salary)+"vnd");
  }
  public  static void August(Employee e1){
    System.out.println("Lương tháng 8: "+(4*5* e1.salary)+"vnd");
  }
